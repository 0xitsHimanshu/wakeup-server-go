		...
		<table style="width: 100%%; max-width: 600px; margin: auto; background-color: #f9f9f9; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
			...
			<tr>
				<td style="padding: 20px;">
					...
					<div style="text-align: center; margin-top: 20px;">
						<a href="https://wakeup.himanshuy.me/dashboard" style="background-color: #5cb85c; color: white; padding: 12px 20px; border-radius: 5px; font-size: 16px; text-decoration: none;">
							Go to Dashboard
						</a>
					</div>
				</td>
			...
			<tr>
				<td style="padding: 20px; text-align: center;">
					...
					<p style="font-size: 12px; color: #bbb;">&copy; 2024 wakeup.himanshuy.me  All rights reserved.</p>
				</td>
			</tr>
		</table>
	</div>
